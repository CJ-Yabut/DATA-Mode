    ...
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
        ...
        <div className="bg-amber-50 p-4 rounded-lg border border-amber-100">
          <h3 className="text-sm font-medium text-amber-800 mb-1">Total Raw Cost</h3>
          <p className="text-2xl font-bold text-amber-900">₱{metrics.totalRawCost.toFixed(2)}</p>
        ...
        <div className="bg-purple-50 p-4 rounded-lg border border-purple-100">
          <h3 className="text-sm font-medium text-purple-800 mb-1">Break-even Point</h3>
          <p className="text-2xl font-bold text-purple-900">
            {metrics.breakEvenUnits === Infinity ? '∞' : metrics.breakEvenUnits} units
          </p>
